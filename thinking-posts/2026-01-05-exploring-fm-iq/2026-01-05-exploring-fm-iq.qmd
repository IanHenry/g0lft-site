...
This animation is included as supplementary material; the visual intuition developed from the static plots stands on its own.  For a full audio-synced MP4, see the [GitHub repository](https://github.com/IanHenry/fm-iq-visualisation).
