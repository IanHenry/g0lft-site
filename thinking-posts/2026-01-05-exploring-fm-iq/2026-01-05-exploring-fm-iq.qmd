...
This animation is included as supplementary material; the visual intuition developed from the static plots stands on its own.  For the script to create a fully audio-synced MP4, see the [GitHub repository](https://github.com/IanHenry/iq-visualisation/fm_broadcast).
...
For complete reproducible scripts, including capture, plotting, and video generation, see the [GitHub repository](https://github.com/IanHenry/iq-visualisation/fm_broadcast).
