...
::: details Load and prepare IQ samples

```python
import numpy as np

# Load saved IQ
data = np.load("iq_capture.npz")
iq = data['iq']
fs = data['fs']
fc = data['fc']

# Drop initial transient samples
iq = iq[1000:]
```
...
For complete reproducible scripts, including capture, plotting, and video generation, see the [GitHub repository](https://github.com/IanHenry/fm-iq-visualisation).
