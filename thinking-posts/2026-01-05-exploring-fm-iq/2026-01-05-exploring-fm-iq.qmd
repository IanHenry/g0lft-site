...
![IQ constellation diagram showing raw iq from a short capture of BBC Radio Cambridgeshire broadcast signal](images/constellation.png){
  #fig-constellation
  fig-align="left"
  width=50%
}
...
These plots come out of my wider [DSP Visualisations](../../projects/dsp-visualisations.qmd)
work, which brings together the tooling for looking at IQ data like this:

- [sdrplay-gnuradio-examples](https://github.com/IanHenry/sdrplay-gnuradio-examples),
  GNU Radio flow graphs for capturing IQ from an SDRplay
- [sdrconnect-iq-visualiser](https://github.com/IanHenry/sdrconnect-iq-visualiser),
  a lightweight SDRconnect plugin if you want IQ plots without the GNU Radio
  learning curve
- [Setup for IQ visualisation and digital signal processing](../../guides-posts/2026-05-10-visualising-iq-setup/2026-05-10-visualising-iq-setup.qmd),
  which covers getting the whole toolchain running

*The specific capture and video-generation scripts behind this post are still
being tidied up for release.*
