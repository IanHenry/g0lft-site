...
- Download the latest installer from the [Radioconda GitHub](https://github.com).
...
- If you are using hardware other than an SDRplay, refer to the [Radioconda ReadMe page](https://github.com#additional-installation-for-device-support) for further guidelines.
...
You are now ready to use GNU Radio to process the IQ output of your SDR receiver. The learning curve can be steep, so I recommend checking out the [GNU Radio wiki](https://gnuradio.org). To get you started, I have included several sample flowgraphs in my repository for you to modify and explore. If you have questions, feel free to [email me](mailto:YOUR_EMAIL_HERE).
...
- Download [SDRconnect](https://sdrplay.com) for Windows, MacOS, or Linux. Ensure you are using at least version 1.08.
