...
---
# Why I Build GB7CAM - "How a £20 Raspberry Pi and a £10 handheld became a packet node, and what the Cambridge 'packet desert' taught me
...
I had heard about [44Net](https://wiki.ampr.org/wiki/Main_Page) on the Ham Radio Workbench podcast. It is the block of IPv4 space set aside for amateur radio experimentation, and I knew that packet nodes could peer over IP as well as over RF, using AXUDP.
...
Somewhere in there I registered gb7cam.org.uk, and was quietly delighted to find such an obvious callsign still unclaimed. The site began as a few pages on GitHub Pages and has since grown an nginx reverse proxy, a subdomain for the node itself, and a FastAPI service that feeds the [status page](https://gb7cam.org.uk/status.html).
